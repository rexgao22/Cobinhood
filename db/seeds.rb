...
Holding.create({ user_id: 19, asset_id: 50, amount: 34 })
Holding.create({ user_id: 19, asset_id: 41, amount: 0 })
Holding.create({ user_id: 19, asset_id: 33, amount: 12 })
Holding.create({ user_id: 19, asset_id: 35, amount: 12 })
