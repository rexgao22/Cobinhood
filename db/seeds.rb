...
Asset.create({ company_name: "Alcoa", ticker_symbol: "AA" })
Asset.create({ company_name: "Alphabet", ticker_symbol: "GOOGL" })
Asset.create({ company_name: "AMD", ticker_symbol: "AMD" })
Asset.create({ company_name: "BILI", ticker_symbol: "Bilibili" })
Asset.create({ company_name: "Bank of America", ticker_symbol: "BAC" })
Asset.create({ company_name: "Boeing", ticker_symbol: "BA" })
Asset.create({ company_name: "Boxlight", ticker_symbol: "BOXL" })
Asset.create({ company_name: "Burlington Stores", ticker_symbol: "BURL" })
...
Asset.create({ company_name: "Zuora Inc", ticker_symbol: "ZUO" })

demo_user = User.create({username: "Admin", password: "helloWorld" })

Holding.create({ user_id: demo_user.id, asset_id: 1, amount: 0 })
Holding.create({ user_id: demo_user.id, asset_id: 3, amount: 6 })
Holding.create({ user_id: demo_user.id, asset_id: 5, amount: 0 })
Holding.create({ user_id: demo_user.id, asset_id: 7, amount: 0 })
Holding.create({ user_id: demo_user.id, asset_id: 50, amount: 34 })
Holding.create({ user_id: demo_user.id, asset_id: 41, amount: 0 })
Holding.create({ user_id: demo_user.id, asset_id: 33, amount: 12 })
Holding.create({ user_id: demo_user.id, asset_id: 35, amount: 12 })
